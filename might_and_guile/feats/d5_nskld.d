...
IF ~Global("D5_FEAT","GLOBAL",1)~ THEN BEGIN d5_nskld
 ...
 IF ~~ THEN REPLY @21021 GOTO d5_nskld_2			//	morale aura
 IF ~~ THEN REPLY @21201 GOTO d5_nskld_6		//	miscast aura
 IF ~~ THEN REPLY @21211 GOTO d5_nskld_8		//	intimidation aura
 IF ~CheckStatGT(myself,7,LEVEL)~ THEN REPLY @21421 GOTO d5_nskld_14		//	mind blank aura
 IF ~CheckStatGT(myself,7,LEVEL)~ THEN REPLY @21431 GOTO d5_nskld_16		//	invulnerability aura
 IF ~CheckStatGT(myself,7,LEVEL)~ THEN REPLY @21471 GOTO d5_nskld_18		//	slow aura
