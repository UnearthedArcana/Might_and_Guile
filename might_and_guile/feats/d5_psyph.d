...
IF ~Global("D5_FEAT","GLOBAL",1)~ THEN BEGIN d5_psyph
 ...
 IF ~GlobalLT("D5_TELEPATHY","LOCALS",2)~ THEN REPLY @20606 GOTO d5_psyph_1	//	geo repair
 ...
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",3) GlobalLT("D5_PSULTRA","LOCALS",1) CheckStatGT(myself,20,LEVEL)~ THEN REPLY @20580 GOTO d5_psyph_60	//	ultrablast
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",3) GlobalLT("D5_PSTOWER","LOCALS",1) CheckStatGT(myself,20,LEVEL)~ THEN REPLY @20582 GOTO d5_psyph_62	//	tower of iron will
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",3) GlobalLT("D5_PSQUAKE","LOCALS",1) CheckStatGT(myself,20,LEVEL)~ THEN REPLY @20585 GOTO d5_psyph_64	//	earthquake
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",3) GlobalLT("D5_PSSTASIS","LOCALS",1) CheckStatGT(myself,20,LEVEL)~ THEN REPLY @20587 GOTO d5_psyph_66	//	stasis field
 IF ~GlobalGT("D5_BIOKINESIS","LOCALS",3) GlobalLT("D5_PSSHAMBLE","LOCALS",1) CheckStatGT(myself,20,LEVEL)~ THEN REPLY @20593 GOTO d5_psyph_68	//	transformation
 IF ~GlobalGT("D5_BIOKINESIS","LOCALS",3) GlobalLT("D5_PSFISSION","LOCALS",1) CheckStatGT(myself,20,LEVEL)~ THEN REPLY @20598 GOTO d5_psyph_70	//	fission
 IF ~GlobalGT("D5_PYROKINESIS","LOCALS",3) GlobalLT("D5_PSFLASH","LOCALS",1) CheckStatGT(myself,20,LEVEL)~ THEN REPLY @20589 GOTO d5_psyph_72	//	solar flash
 IF ~GlobalGT("D5_PYROKINESIS","LOCALS",3) GlobalLT("D5_PSSTORM","LOCALS",1) CheckStatGT(myself,20,LEVEL)~ THEN REPLY @20591 GOTO d5_psyph_74	//	energy storm
 IF ~GlobalLT("D5_SKILLS","LOCALS",2)~ THEN REPLY @20101 GOTO d5_psyph_102
 IF ~GlobalLT("D5_SKILLS","LOCALS",2)~ THEN REPLY @20103 GOTO d5_psyph_104
 IF ~GlobalLT("D5_SKILLS","LOCALS",2)~ THEN REPLY @20105 GOTO d5_psyph_106
 IF ~GlobalLT("D5_LORE","LOCALS",2)~ THEN REPLY @20301 GOTO d5_psyph_108
 IF ~GlobalLT("D5_EVADE","LOCALS",2)~ THEN REPLY @20201 GOTO d5_psyph_110
 IF ~GlobalLT("D5_ATTACK","LOCALS",2)~ THEN REPLY @20231 GOTO d5_psyph_112
 IF ~GlobalGT("D5_ATTACK","LOCALS",0) GlobalLT("D5_DISARM","LOCALS",1)~ THEN REPLY @20253 GOTO d5_psyph_114
 IF ~GlobalGT("D5_ATTACK","LOCALS",0) GlobalLT("D5_DISRUPT","LOCALS",1)~ THEN REPLY @20257 GOTO d5_psyph_116
END
