...
IF ~Global("D5_FEAT","GLOBAL",1)~ THEN BEGIN d5_alchm
 SAY @20009
 IF ~GlobalLT("D5_SKILS","LOCALS",5)~ THEN REPLY @20101 GOTO d5_alchm_1
 IF ~GlobalLT("D5_SKILS","LOCALS",5)~ THEN REPLY @20103 GOTO d5_alchm_2
 IF ~GlobalLT("D5_SKILS","LOCALS",5)~ THEN REPLY @20105 GOTO d5_alchm_3
 ...
 IF ~GlobalLT("D5_ALCHM","LOCALS",1)~ THEN REPLY @20131 GOTO d5_alchm_6
 IF ~GlobalGT("D5_ALCHM","LOCALS",0) GlobalLT("D5_ADVALCH","LOCALS",1)~ THEN REPLY @20181 GOTO d5_alchm_7
 IF ~GlobalLT("D5_GASTH","LOCALS",2)~ THEN REPLY @20271 GOTO d5_alchm_14
 IF ~GlobalLT("D5_FLAMW","LOCALS",3)~ THEN REPLY @20151 GOTO d5_alchm_8
 IF ~GlobalGT("D5_DTRAP","LOCALS",0) GlobalGT("D5_ALCHM","LOCALS",0) GlobalLT("D5_FTRAP","LOCALS",3)~ THEN REPLY @20115 GOTO d5_alchm_9
 IF ~GlobalLT("D5_POIST","LOCALS",1)~ THEN REPLY @20161 GOTO d5_alchm_10
 IF ~GlobalLT("D5_POISP","LOCALS",1)~ THEN REPLY @20163 GOTO d5_alchm_11
 IF ~GlobalGT("D5_ALCHM","LOCALS",0) GlobalLT("D5_HULK","LOCALS",1)~ THEN REPLY @20171 GOTO d5_alchm_12
 IF ~GlobalLT("D5_SAVES","LOCALS",1)~ THEN REPLY @20211 GOTO d5_alchm_13
 IF ~GlobalLT("D5_IFORT","LOCALS",1)~ THEN REPLY @20309 GOTO d5_alchm_61
 IF ~GlobalLT("D5_SLIP","LOCALS",1)~ THEN REPLY @20217 GOTO d5_alchm_48
 IF ~GlobalLT("D5_ILLUM","LOCALS",2) CheckStatGT(myself,14,INT) CheckStatGT(myself,9,LEVEL)~ THEN REPLY @20283 GOTO d5_alchm_15
 IF ~GlobalLT("D5_UMD","LOCALS",1) CheckStatGT(myself,14,INT) CheckStatGT(myself,7,LEVEL)~ THEN REPLY @20293 GOTO d5_alchm_17
END
