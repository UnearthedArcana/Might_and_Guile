...
SAY @20009
 IF ~GlobalLT("D5_SKILS","LOCALS",5)~ THEN REPLY @20101 GOTO d5_asasn_11
// IF ~GlobalLT("D5_SKILS","LOCALS",5)~ THEN REPLY @20103 GOTO d5_asasn_12
// IF ~GlobalLT("D5_SKILS","LOCALS",5)~ THEN REPLY @20105 GOTO d5_asasn_13
 IF ~GlobalLT("D5_LORE","LOCALS",5)~ THEN REPLY @20301 GOTO d5_asasn_14
 IF ~GlobalLT("D5_STRID","LOCALS",1)~ THEN REPLY @2210 GOTO d5_asasn_16
 IF ~GlobalLT("D5_TRAPS","LOCALS",3)~ THEN REPLY @20113 GOTO d5_asasn_21
 IF ~GlobalLT("D5_POIST","LOCALS",3)~ THEN REPLY @20161 GOTO d5_asasn_33
 IF ~GlobalGT("D5_DTRAP","LOCALS",0) GlobalGT("D5_POIST","LOCALS",0) GlobalLT("D5_PTRAP","LOCALS",3)~ THEN REPLY @20119 GOTO d5_asasn_25
 IF ~GlobalLT("D5_ALCHM","LOCALS",1)~ THEN REPLY @20131 GOTO d5_asasn_31
 IF ~GlobalLT("D5_GASTH","LOCALS",2)~ THEN REPLY @20271 GOTO d5_asasn_81
 IF ~GlobalGT("D5_ALCHM","LOCALS",1) GlobalLT("D5_FLAMW","LOCALS",3)~ THEN REPLY @20151 GOTO d5_asasn_36
 IF ~GlobalLT("D5_DODGE","LOCALS",2)~ THEN REPLY @20201 GOTO d5_asasn_41
 IF ~GlobalLT("D5_SNARE","LOCALS",1) CheckStatGT(myself,6,LEVEL)~ THEN REPLY @20203 GOTO d5_asasn_44
 IF ~GlobalLT("D5_SAVES","LOCALS",1)~ THEN REPLY @20211 GOTO d5_asasn_45
 IF ~GlobalLT("D5_SLIP","LOCALS",1)~ THEN REPLY @20217 GOTO d5_asasn_48
 IF ~GlobalLT("D5_EVADE","LOCALS",1)~ THEN REPLY @20223 GOTO d5_asasn_43
 IF ~GlobalLT("D5_ATACK","LOCALS",1)~ THEN REPLY @20231 GOTO d5_asasn_51
 IF ~GlobalLT("D5_RTHAC","LOCALS",2)~ THEN REPLY @20233 GOTO d5_asasn_52
 IF ~GlobalLT("D5_BSTAB","LOCALS",3)~ THEN REPLY @20241 GOTO d5_asasn_55
 ...
 IF ~GlobalGT("D5_ATACK","LOCALS",0) GlobalLT("D5_DIRTY","LOCALS",1)~ THEN REPLY @20259 GOTO d5_asasn_75
 IF ~GlobalGT("D5_ATACK","LOCALS",0) GlobalLT("D5_DSRPT","LOCALS",1)~ THEN REPLY @20257 GOTO d5_asasn_74
 IF ~GlobalLT("D5_SHADM","LOCALS",2) CheckStatGT(myself,14,INT) CheckStatGT(myself,9,LEVEL)~ THEN REPLY @2755 GOTO d5_asasn_85
 IF ~GlobalLT("D5_UMD","LOCALS",1) CheckStatGT(myself,14,INT) CheckStatGT(myself,7,LEVEL)~ THEN REPLY @20293 GOTO d5_asasn_84
END
...
IF ~~ THEN BEGIN d5_asasn_33 // toxic poison
 SAY @20162
 IF ~~ THEN REPLY @20098 DO ~IncrementGlobal("D5_ALCHM","LOCALS",1)~ DO ~ApplySpellRES("D5_RFC3",myself)~ EXIT 
 IF ~~ THEN REPLY @20097 GOTO d5_asasn 
END 
...
IF ~~ THEN BEGIN d5_asasn_41 // AC bonus
 ...
 IF ~~ THEN REPLY @20097 GOTO d5_asasn 
END 
IF ~~ THEN BEGIN d5_asasn_44 // missile snaring
 SAY @20204
