...
SAY @20009
 IF ~GlobalLT("D5_SKILS","LOCALS",5)~ THEN REPLY @20101 GOTO d5_huntr_11
// IF ~GlobalLT("D5_SKILS","LOCALS",5)~ THEN REPLY @20103 GOTO d5_huntr_12
 IF ~GlobalLT("D5_SKILS","LOCALS",6)~ THEN REPLY @20105 GOTO d5_huntr_13
// IF ~GlobalLT("D5_LORE","LOCALS",5)~ THEN REPLY @20301 GOTO d5_huntr_14
 IF ~GlobalLT("D5_STRID","LOCALS",1)~ THEN REPLY @2210 GOTO d5_huntr_16
 IF ~GlobalLT("D5_TRACK","LOCALS",1)~ THEN REPLY @20107 GOTO d5_huntr_19
 ...
 IF ~GlobalLT("D5_POISP","LOCALS",3)~ THEN REPLY @20163 GOTO d5_huntr_34
 IF ~GlobalLT("D5_GASTH","LOCALS",2)~ THEN REPLY @20271 GOTO d5_huntr_81
 IF ~GlobalLT("D5_FLAMW","LOCALS",3)~ THEN REPLY @20151 GOTO d5_huntr_36
 IF ~GlobalLT("D5_DODGE","LOCALS",2)~ THEN REPLY @20201 GOTO d5_huntr_41
 IF ~GlobalLT("D5_SNARE","LOCALS",1) CheckStatGT(myself,6,LEVEL)~ THEN REPLY @20203 GOTO d5_huntr_44
 IF ~GlobalLT("D5_SAVES","LOCALS",1)~ THEN REPLY @20211 GOTO d5_huntr_45
 IF ~GlobalLT("D5_IFORT","LOCALS",1)~ THEN REPLY @20309 GOTO d5_huntr_61
 IF ~GlobalLT("D5_SLIP","LOCALS",1)~ THEN REPLY @20217 GOTO d5_huntr_48
 IF ~GlobalLT("D5_EVADE","LOCALS",1)~ THEN REPLY @20223 GOTO d5_huntr_43
 IF ~GlobalLT("D5_ATACK","LOCALS",2)~ THEN REPLY @20231 GOTO d5_huntr_51
 IF ~GlobalLT("D5_RTHAC","LOCALS",2)~ THEN REPLY @20233 GOTO d5_huntr_52
 IF ~GlobalGT("D5_ATACK","LOCALS",0) GlobalLT("D5_BSTAB","LOCALS",1)~ THEN REPLY @20241 GOTO d5_huntr_55
 ...
 IF ~GlobalLT("D5_DSRPT","LOCALS",1)~ THEN REPLY @20257 GOTO d5_huntr_74
 IF ~GlobalLT("D5_UMD","LOCALS",1) CheckStatGT(myself,14,INT) CheckStatGT(myself,7,LEVEL)~ THEN REPLY @20293 GOTO d5_huntr_84
END
...
IF ~~ THEN BEGIN d5_huntr_16 // quickstride
 ...
 IF ~~ THEN REPLY @20097 GOTO d5_huntr 
END 
IF ~~ THEN BEGIN d5_huntr_19 // tracking
 SAY @20108
...
IF ~~ THEN BEGIN d5_huntr_41 // AC bonus
 ...
 IF ~~ THEN REPLY @20097 GOTO d5_huntr 
END 
IF ~~ THEN BEGIN d5_huntr_44 // missile snaring
 SAY @20204
