...
IF ~Global("D5_FEAT","GLOBAL",1)~ THEN BEGIN d5_shado
 ...
 IF ~GlobalLT("D5_DODGE","LOCALS",1)~ THEN REPLY @20223 GOTO d5_shado_43
 ...
 IF ~GlobalLT("D5_RWANDS","LOCALS",1) CheckStatGT(myself,11,INT) CheckStatGT(myself,7,LEVEL)~ THEN REPLY @20291 GOTO d5_shado_19
...
IF ~~ THEN BEGIN d5_shado_10 // save bonus
 ...
 IF ~~ THEN REPLY @20097 GOTO d5_shado 
END 
IF ~~ THEN BEGIN d5_shado_43 // artful dodging (iwdee evasion)
 SAY @20224
