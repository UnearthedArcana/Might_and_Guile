...
IF ~GlobalLT("D5_EVADE","LOCALS",2)~ THEN REPLY @20201 GOTO d5_shado_9
...
IF ~GlobalGT("D5_RMAGIC","LOCALS",0) GlobalLT("D5_RWANDS","LOCALS",1) CheckStatGT(myself,11,INT)~ THEN REPLY @20291 GOTO d5_shado_19
IF ~GlobalGT("D5_RWANDS","LOCALS",0) GlobalLT("D5_RSCROLL","LOCALS",1) CheckStatGT(myself,14,INT)~ THEN REPLY @20293 GOTO d5_shado_20
END
...
IF ~~ THEN BEGIN d5_shado_18 // shadow magic
 ...
 IF ~~ THEN REPLY @20097 GOTO d5_shado 
END 
IF ~~ THEN BEGIN d5_shado_19 // use wands
 SAY @20292
