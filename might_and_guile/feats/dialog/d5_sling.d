...
SAY @23101	//	~Choose a Called Shot:~
 IF ~GlobalLT("D5_ATRIP","LOCALS",1)~ THEN REPLY @23113 GOTO d5_sling_1 	//	trip
 IF ~GlobalLT("D5_ADSRM","LOCALS",1)~ THEN REPLY @23115 GOTO d5_sling_2 	//	disarm
 IF ~GlobalLT("D5_ACRIP","LOCALS",1) CheckStatGT(myself,2,LEVEL)~ THEN REPLY @23119 GOTO d5_sling_3		//	cripple = 6
 IF ~GlobalLT("D5_ABLND","LOCALS",1) CheckStatGT(myself,7,LEVEL)~ THEN REPLY @23121 GOTO d5_sling_4 	//	blind = 6
 IF ~GlobalLT("D5_AHAMR","LOCALS",1) CheckStatGT(myself,7,LEVEL)~ THEN REPLY @23117 GOTO d5_sling_5 	//	hammer = 9
 IF ~GlobalLT("D5_ASTUN","LOCALS",1) CheckStatGT(myself,4,LEVEL)~ THEN REPLY @23123 GOTO d5_sling_6 	//	stun = 9
 IF ~GlobalLT("D5_HLTHY","LOCALS",1)~ THEN REPLY @20305 GOTO d5_sling_17
 IF ~GlobalLT("D5_TOUGH","LOCALS",1)~ THEN REPLY @20307 GOTO d5_sling_18
 IF ~GlobalLT("D5_MSAVE","LOCALS",1)~ THEN REPLY @20213 GOTO d5_sling_46
 IF ~GlobalLT("D5_PSAVE","LOCALS",1)~ THEN REPLY @20215 GOTO d5_sling_47
 IF ~GlobalLT("D5_IFORT","LOCALS",1)~ THEN REPLY @20309 GOTO d5_sling_61
 IF ~GlobalLT("D5_DTRMN","LOCALS",1)~ THEN REPLY @20219 GOTO d5_sling_49
 ...
 IF ~GlobalLT("D5_STRID","LOCALS",1)~ THEN REPLY @2210 GOTO d5_sling_16
 IF ~GlobalLT("D5_TRACK","LOCALS",1)~ THEN REPLY @20107 GOTO d5_sling_19
END
...
IF ~~ THEN BEGIN d5_sling_47 // death/polymorph saves
 ...
 IF ~~ THEN REPLY @20097 GOTO d5_sling 
END 
IF ~~ THEN BEGIN d5_sling_61 // poison/disease evasion
 SAY @20310
 IF ~~ THEN REPLY @20098 DO ~IncrementGlobal("D5_IFORT","LOCALS",1)~ DO ~ApplySpellRES("D5_RFF1",myself)~ EXIT 
 IF ~~ THEN REPLY @20097 GOTO d5_sling 
END 
IF ~~ THEN BEGIN d5_sling_49 // unflagging determination
 SAY @20220
...
IF ~~ THEN BEGIN d5_sling_16 // quickstride
 ...
 IF ~~ THEN REPLY @20097 GOTO d5_sling 
END 
IF ~~ THEN BEGIN d5_sling_19 // tracking
 SAY @20108
