...
IF ~PartyGoldLT(225)~ THEN BEGIN d5_Rech000
SAY @115040
IF ~~ THEN EXIT
END
...
//IF ~Global("d5_T7","GLOBAL",0)~ THEN REPLY @115159 GOTO d5_Rech700  //Tier 7 Wands
...
SAY @115123
IF ~HasItem("d5_WND13",Myself)~ THEN REPLY @115205 DO  ~TakePartyGold(2500) DestroyGold(2500)  TakePartyItemNum("SCRL1X",1) DestroyItem("SCRL1X") DestroyItem("d5_WND12") GiveItemCreate("d5_WND13",Myself,10,1,1)~ EXIT
...
SAY @115122
IF ~HasItem("d5_WND13",Myself)~ THEN REPLY @115205 DO  ~TakePartyGold(2500) DestroyGold(2500)  RemoveSpell(WIZARD_ICE_STORM) DestroyItem("d5_WND12") GiveItemCreate("d5_WND13",Myself,10,1,1)~ EXIT
IF ~~ THEN REPLY @115043 GOTO d5_Rech401
IF ~~ THEN REPLY @115046 GOTO d5_Rech001
IF ~~ THEN REPLY @115015 EXIT
END
...
IF ~Global("d5_COR","GLOBAL",1)~ THEN REPLY @115216 GOTO d5_Rech603 //Wand of Corr
...
IF ~~ THEN BEGIN d5_Rech603     //Wand of Corr
SAY @115043
IF ~PartyHasItemIdentified("SCDFOG")~ THEN REPLY @115224 GOTO d5_Rech603_01
IF ~PartyHasItemIdentified("SCRL7R")~ THEN REPLY @115224 GOTO d5_Rech603_02
IF ~HaveSpell(WIZARD_DEATH_FOG)~ THEN REPLY @115225 GOTO d5_Rech603_03
IF ~~ THEN REPLY @115046 GOTO d5_Rech001
IF ~~ THEN REPLY @115015 EXIT
END

IF ~~ THEN BEGIN d5_Rech603_01               //Scroll
SAY @115224
IF ~HasItem("d5_WND18",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(6250) DestroyGold(6250)  TakePartyItemNum("SCDFOG",1) DestroyItem("SCDFOG") DestroyItem("d5_WND18") GiveItemCreate("d5_WND18",Myself,7,1,1)~ EXIT
IF ~~ THEN REPLY @115043 GOTO d5_Rech603
IF ~~ THEN REPLY @115046 GOTO d5_Rech001
IF ~~ THEN REPLY @115015 EXIT
END

IF ~~ THEN BEGIN d5_Rech603_02               //Scroll
SAY @115224
IF ~HasItem("d5_WND18",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(6250) DestroyGold(6250)  TakePartyItemNum("SCRL7R",1) DestroyItem("SCRL7R") DestroyItem("d5_WND18") GiveItemCreate("d5_WND18",Myself,7,1,1)~ EXIT
IF ~~ THEN REPLY @115043 GOTO d5_Rech603
IF ~~ THEN REPLY @115046 GOTO d5_Rech001
IF ~~ THEN REPLY @115015 EXIT
END
...
IF ~~ THEN BEGIN d5_Rech603_03               //Spell
SAY @115219
IF ~HasItem("d5_WND18",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(6250) DestroyGold(6250)  RemoveSpell(WIZARD_DEATH_FOG) DestroyItem("d5_WND18") GiveItemCreate("d5_WND18",Myself,7,1,1)~ EXIT
IF ~~ THEN REPLY @115043 GOTO d5_Rech603
IF ~~ THEN REPLY @115046 GOTO d5_Rech001
IF ~~ THEN REPLY @115015 EXIT
END
