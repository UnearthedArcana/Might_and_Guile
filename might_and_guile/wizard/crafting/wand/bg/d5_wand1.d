...
SAY @115084
IF ~HaveSpell(WIZARD_HORROR)~ THEN REPLY @115052 DO ~TakePartyGold(1900) DestroyGold(1900) RemoveSpell(WIZARD_HORROR) GiveItemCreate("d5_WND03",Myself,24,1,1)~ EXIT
IF ~PartyHasItemIdentified("SCRL89")~ THEN REPLY @115051 DO ~TakePartyGold(1900) DestroyGold(1900) TakePartyItemNum("SCRL89",1) DestroyItem("SCRL89") GiveItemCreate("d5_WND03",Myself,24,1,1)~ EXIT
...
SAY @115084
IF ~HaveSpell(WIZARD_ICE_STORM)~ THEN REPLY @115122 DO ~TakePartyGold(10000) DestroyGold(10000) RemoveSpell(WIZARD_ICE_STORM) GiveItemCreate("d5_WND13",Myself,10,1,1) ~ EXIT
IF ~PartyHasItemIdentified("SCRL1X")~ THEN REPLY @115123 DO ~TakePartyGold(10000) DestroyGold(10000) TakePartyItemNum("SCRL1X",1) DestroyItem("SCRL1X") GiveItemCreate("d5_WND13",Myself,10,1,1)~ EXIT
...
SAY @115084
IF ~HaveSpell(WIZARD_ICE_STORM)~ THEN REPLY @115122 DO ~TakePartyGold(5000) DestroyGold(5000) RemoveSpell(WIZARD_ICE_STORM) GiveItemCreate("d5_WND13",Myself,10,1,1) ~ EXIT
IF ~PartyHasItemIdentified("SCRL1X")~ THEN REPLY @115123 DO ~TakePartyGold(5000) DestroyGold(5000) TakePartyItemNum("SCRL1X",1) DestroyItem("SCRL1X") GiveItemCreate("d5_WND13",Myself,10,1,1)~ EXIT
...
IF ~Global("d5_ASW","GLOBAL",1)~ THEN REPLY @115146 GOTO d5_Wand603   //Wand of Corrosion
IF ~~ THEN REPLY @115087 GOTO d5_Wand005
IF ~~ THEN REPLY @115015 EXIT
END
...
IF ~Global("d5_ASW","GLOBAL",1)~ THEN REPLY @115146 GOTO d5_Wand603_1   //Wand of Corrosion
IF ~~ THEN REPLY @115087 GOTO d5_Wand005
IF ~~ THEN REPLY @115015 EXIT
END
...
IF ~~ THEN BEGIN d5_Wand603   //Wand of Corrosion
SAY @115084
IF ~HaveSpell(WIZARD_DEATH_FOG)~ THEN REPLY @115140 DO ~TakePartyGold(25000) DestroyGold(25000) RemoveSpell(WIZARD_DEATH_FOG) GiveItemCreate("d5_WND18",Myself,7,1,1) ~ EXIT
IF ~PartyHasItemIdentified("SCDFOG")~ THEN REPLY @115141 DO ~TakePartyGold(25000) DestroyGold(25000) TakePartyItemNum("SCDFOG",1) DestroyItem("SCDFOG") GiveItemCreate("d5_WND18",Myself,7,1,1)~ EXIT
IF ~PartyHasItemIdentified("SCRL7R")~ THEN REPLY @115141 DO ~TakePartyGold(25000) DestroyGold(25000) TakePartyItemNum("SCRL7R",1) DestroyItem("SCRL7R") GiveItemCreate("d5_WND18",Myself,7,1,1)~ EXIT
IF ~~ THEN REPLY @115135 GOTO d5_Wand600
IF ~~ THEN REPLY @115087 GOTO d5_Wand005
IF ~~ THEN REPLY @115015 EXIT
END

IF ~~ THEN BEGIN d5_Wand603_1   //Wand of Corrosion
SAY @115084
IF ~HaveSpell(WIZARD_DEATH_FOG)~ THEN REPLY @115140 DO ~TakePartyGold(25000) DestroyGold(25000) RemoveSpell(WIZARD_DEATH_FOG) GiveItemCreate("d5_WND18",Myself,7,1,1) ~ EXIT
IF ~PartyHasItemIdentified("SCDFOG")~ THEN REPLY @115141 DO ~TakePartyGold(25000) DestroyGold(25000) TakePartyItemNum("SCDFOG",1) DestroyItem("SCDFOG") GiveItemCreate("d5_WND18",Myself,7,1,1)~ EXIT
IF ~PartyHasItemIdentified("SCRL7R")~ THEN REPLY @115141 DO ~TakePartyGold(25000) DestroyGold(25000) TakePartyItemNum("SCRL7R",1) DestroyItem("SCRL7R") GiveItemCreate("d5_WND18",Myself,7,1,1)~ EXIT
